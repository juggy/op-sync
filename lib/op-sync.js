(function() {
  var OS, _config, _extend, _implements, _ref, _server, _transforms;
  ...
  _extend = function(obj) {
    var prop, source, _i, _j, _len, _len2, _ref2;
    _ref2 = Array.prototype.slice.call(arguments, 1);
    for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
      source = _ref2[_i];
      for (_j = 0, _len2 = source.length; _j < _len2; _j++) {
        prop = source[_j];
        if (source[prop]) {
  ...
  OS.Device = (function() {
    function Device(config, uuid) {
      ...
      config = _extends(_config.splice(0), config);
      ...
      this.sync_log = this.uuid ? (backlog = this.store.get(uuid), new OS.SyncLog(this, backlog)) : (this.uuid = this.gen_uuid(), this.register(), new OS.SyncLog(this, backlog));
    }
    ...
    Device.prototype.save = function() {
      ...
      return this.store.set(this.uuid, this.sync_log.backlog);
    };
  ...
  OS.SyncLog = (function() {
    ...
    SyncLog.prototype.post_sync_process = function() {
      ...
      for (instance = 0, _len2 = _ref3.length; instance < _len2; instance++) {
        ...
        this.device.events.update(instance.model, instance.id, instance.compile(fields));
      }
